            ...
            >
                ...
                <div>
                    ...
                    <p className="text-white/70 text-sm leading-relaxed">
                        Press <kbd className="px-2 py-1 bg-white/10 rounded border border-white/20 text-white font-mono text-xs">Fullscreen</kbd> or <kbd className="px-2 py-1 bg-white/10 rounded border border-white/20 text-white font-mono text-xs">F11</kbd> and then switch to another app to put the wallpaper in the background. <br></br><br></br> Tip: Press <kbd className="px-2 py-1 bg-white/10 rounded border border-white/20 text-white font-mono text-xs">esc</kbd> while the wallpaper is focused to return to the wallpaper picker.
                    </p>
                </div>
